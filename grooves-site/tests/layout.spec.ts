...
test.describe("Basic Layout Tests", () => {
  ...
  test("should have Font Awesome icons in buttons", async ({ page }) => {
    ...
    await expect(
      page.locator('a[href*="github.com/rahulsom/grooves"] .fa-github')
    ).toBeVisible();
  ...
  test("should have three feature columns", async ({ page }) => {
    ...
    await expect(
      page.locator("h3").filter({ hasText: "Languages" })
    ).toBeVisible();
    await expect(
      page.locator("h3").filter({ hasText: "Reactive Streams" })
    ).toBeVisible();
    await expect(
      page.locator("h3").filter({ hasText: "Application Architectures" })
    ).toBeVisible();
  });
  ...
  test("should highlight key technologies in bold", async ({ page }) => {
    ...
    await expect(
      strongElements.filter({ hasText: "Java" }).first()
    ).toBeVisible();
    ...
    await expect(
      strongElements.filter({ hasText: "Reactive Streams" })
    ).toBeVisible();
