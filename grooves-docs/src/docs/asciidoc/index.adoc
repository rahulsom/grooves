...
This is a good example for https://github.com/rahulsom/grooves/blob/master/examples/grails/rdbms_mongo/grails-app/domain/grooves/grails/mongo/ZipcodePatients.groovy[a join].
...
This is a good example for such a https://github.com/rahulsom/grooves/blob/master/examples/grails/rdbms_mongo/src/main/groovy/grooves/grails/mongo/ZipcodePatientsQuery.groovy[query].
...
[source,kotlin]
----
include::{sourcedir}/examples/pushstyle/src/main/kotlin/grooves/example/push/EventService.kt[tags=documented]
----
