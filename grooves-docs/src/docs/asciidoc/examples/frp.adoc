...
The full source for _Push Style_ Event Sourcing with _jOOQ_ and FRP, look at https://github.com/rahulsom/grooves/tree/main/examples/pushstyle[this subproject].
