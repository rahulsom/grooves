...
include::{sourcedir}/examples/grooves-example-javaee/src/main/java/grooves/example/javaee/domain/PatientEvent.java[tags=documented]
----
...
----
// All imports omitted
include::{sourcedir}/examples/grooves-example-springboot/grooves-example-springboot-jpa/src/main/groovy/grooves/boot/jpa/domain/PatientEvent.groovy[tags=abstract]
----
<1> You'll have to extend `BaseEvent`.
...
----
// All imports omitted
include::{sourcedir}/examples/grooves-example-springboot/grooves-example-springboot-kotlin/src/main/kotlin/grooves/boot/kotlin/domain/PatientEvent.kt[tags=patientEvent]
----
