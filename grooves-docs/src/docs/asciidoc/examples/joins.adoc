...
[source,groovy]
----
include::{sourcedir}/examples/grooves-example-springboot/grooves-example-springboot-jpa/src/main/groovy/grooves/boot/jpa/domain/ZipcodeEvent.groovy[tags=joins]
----
...
[source,groovy]
----
include::{sourcedir}/examples/grooves-example-springboot/grooves-example-springboot-jpa/src/main/groovy/grooves/boot/jpa/queries/ZipcodePatientsQuery.groovy[tags=joins]
----
