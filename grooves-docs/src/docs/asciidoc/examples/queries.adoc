...
<10> This annotation is the final step in verification of completeness.
...
<11> Each of these methods takes the event and the snapshot as inputs and returns an `Observable<EventApplyOutcome>` as output.
  It can `CONTINUE` or `RETURN`.
