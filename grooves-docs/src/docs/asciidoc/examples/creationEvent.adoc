...
----
<1> For most events you're interested in as a user, you'll just have to extend `PatientEvent`.
<2> The other thing is to implement an audit message.
...
<3> The other thing is to implement an audit message.
