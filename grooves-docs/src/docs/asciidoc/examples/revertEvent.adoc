...
.Java
----
include::{sourcedir}/examples/grooves-example-javaee/src/main/java/grooves/example/javaee/domain/PatientEventReverted.java[tags=documented]
----
...
.Groovy
----
include::{sourcedir}/examples/grooves-example-springboot/grooves-example-springboot-jpa/src/main/groovy/grooves/boot/jpa/domain/PatientEvent.groovy[tags=reverted]
----
<1> Like your business events, you'll extend `PatientEvent`.
...
include::{sourcedir}/examples/grooves-example-springboot/grooves-example-springboot-kotlin/src/main/kotlin/grooves/boot/kotlin/domain/PatientEvent.kt[tags=reverted]
}
----
