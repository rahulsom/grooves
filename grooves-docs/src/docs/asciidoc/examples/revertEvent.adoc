...
.Java
----
include::{sourcedir}/examples/javaee/src/main/java/grooves/example/javaee/domain/PatientEventReverted.java[tags=documented]
----
...
.Groovy
----
include::{sourcedir}/examples/springboot/jpa/src/main/groovy/grooves/boot/jpa/domain/PatientEvent.groovy[tags=reverted]
----
<1> Like your business events, you'll extend `PatientEvent`.
...
.Gorm
----
include::{sourcedir}/examples/grails/rdbms_mongo/grails-app/domain/grooves/grails/mongo/PatientEvent.groovy[tags=reverted]
----
<1> Like your business events, you'll extend `PatientEvent`.
  You do not need to annotate it as an Event.
  Even if you do, you cannot process this event.
...
include::{sourcedir}/examples/springboot/kotlin/src/main/kotlin/grooves/boot/kotlin/domain/PatientEvent.kt[tags=reverted]
}
----
