...
class Aggregate(
    ...
    override fun toString(): String = "|$type,$id,$description\n${events.joinToString("\n") { it.toString() }}"
        ...
        return g.withSVGDescriptionClassOrSVGAnimationClassOrSVGStructureClass(
            objectFactory.createRect(
                objectFactory
                    ...
                    .withX("10")
                    .withY(y.toString())
                    .withWidth("$AGGREGATE_WIDTH")
                    .withHeight("$AGGREGATE_HEIGHT"),
            ),
            objectFactory.createText(
                objectFactory
                    .createText()
                    .withX("15")
                    .withY("${y + TEXT_LINE_HEIGHT}")
                    .withClazz("type")
                    .withContent(type),
            ),
            objectFactory.createText(
